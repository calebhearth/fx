...
describe "User manages views" do
  it "handles simple views" do
    ...
    successfully "rake db:rollback"
    successfully "rails destroy fx:model search_result"
  end

  it "handles materialized views" do
    successfully "rails generate fx:model child --materialized"
    ...
    successfully "rails generate fx:view child --materialized"
    ...
    successfully "rake db:rollback"
    successfully "rake db:rollback"
    successfully "rails destroy fx:model child"
  end
